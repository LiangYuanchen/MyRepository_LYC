...
namespace _13W
{
    ...
    partial void InsertAct_Correlation(Act_Correlation instance);
    partial void UpdateAct_Correlation(Act_Correlation instance);
    partial void DeleteAct_Correlation(Act_Correlation instance);
    ...
    partial void InsertActClauseNote(ActClauseNote instance);
    partial void UpdateActClauseNote(ActClauseNote instance);
    partial void DeleteActClauseNote(ActClauseNote instance);
    #endregion
		
		public DataClasses1DataContext() : 
				base(global::_13W.Properties.Settings.Default.SPDActConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Act_Correlation> Act_Correlation
		{
			get
			{
				return this.GetTable<Act_Correlation>();
			}
		}
		...
		public System.Data.Linq.Table<ActClauseNote> ActClauseNote
		{
			get
			{
				return this.GetTable<ActClauseNote>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Act_Correlation")]
	public partial class Act_Correlation : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ToActID;
		
		private System.Nullable<int> _ToItemID;
		
		private System.Nullable<int> _FromActID;
		
		private System.Nullable<int> _FromItemID;
		
		private string _FromActName;
		
		private string _FromItemContent;
		
		private string _FromItemName;
    ...
    partial void OnToActIDChanging(System.Nullable<int> value);
    partial void OnToActIDChanged();
    partial void OnToItemIDChanging(System.Nullable<int> value);
    partial void OnToItemIDChanged();
    partial void OnFromActIDChanging(System.Nullable<int> value);
    partial void OnFromActIDChanged();
    partial void OnFromItemIDChanging(System.Nullable<int> value);
    partial void OnFromItemIDChanged();
    partial void OnFromActNameChanging(string value);
    partial void OnFromActNameChanged();
    partial void OnFromItemContentChanging(string value);
    partial void OnFromItemContentChanged();
    partial void OnFromItemNameChanging(string value);
    partial void OnFromItemNameChanged();
    #endregion
		
		public Act_Correlation()
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ToActID", DbType="Int")]
		public System.Nullable<int> ToActID
		{
			get
			{
				return this._ToActID;
			}
			set
			{
				if ((this._ToActID != value))
				{
					this.OnToActIDChanging(value);
					this.SendPropertyChanging();
					this._ToActID = value;
					this.SendPropertyChanged("ToActID");
					this.OnToActIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ToItemID", DbType="Int")]
		public System.Nullable<int> ToItemID
		{
			get
			{
			...
			set
			{
				if ((this._ToItemID != value))
				{
					this.OnToItemIDChanging(value);
					this.SendPropertyChanging();
					this._ToItemID = value;
					this.SendPropertyChanged("ToItemID");
					this.OnToItemIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromActID", DbType="Int")]
		public System.Nullable<int> FromActID
		{
			get
			{
				return this._FromActID;
			}
			set
			{
				if ((this._FromActID != value))
				{
					this.OnFromActIDChanging(value);
					this.SendPropertyChanging();
					this._FromActID = value;
					this.SendPropertyChanged("FromActID");
					this.OnFromActIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromItemID", DbType="Int")]
		public System.Nullable<int> FromItemID
		{
			get
			{
				return this._FromItemID;
			}
			set
			{
				if ((this._FromItemID != value))
				{
					this.OnFromItemIDChanging(value);
					this.SendPropertyChanging();
					this._FromItemID = value;
					this.SendPropertyChanged("FromItemID");
					this.OnFromItemIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromActName", DbType="NVarChar(500)")]
		public string FromActName
		{
			get
			{
				return this._FromActName;
			}
			set
			{
				if ((this._FromActName != value))
				{
					this.OnFromActNameChanging(value);
					this.SendPropertyChanging();
					this._FromActName = value;
					this.SendPropertyChanged("FromActName");
					this.OnFromActNameChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromItemContent", DbType="NVarChar(MAX)")]
		public string FromItemContent
		{
			get
			{
				return this._FromItemContent;
			}
			set
			{
				if ((this._FromItemContent != value))
				{
					this.OnFromItemContentChanging(value);
					this.SendPropertyChanging();
					this._FromItemContent = value;
					this.SendPropertyChanged("FromItemContent");
					this.OnFromItemContentChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromItemName", DbType="NVarChar(500)")]
		public string FromItemName
		{
			get
			{
				return this._FromItemName;
			}
			set
			{
				if ((this._FromItemName != value))
				{
					this.OnFromItemNameChanging(value);
					this.SendPropertyChanging();
					this._FromItemName = value;
					this.SendPropertyChanged("FromItemName");
					this.OnFromItemNameChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ActClauseNote")]
	public partial class ActClauseNote : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnToActNameChanging(string value);
    partial void OnToActNameChanged();
    partial void OnToActIDChanging(System.Nullable<int> value);
    partial void OnToActIDChanged();
    partial void OnToItemIDChanging(System.Nullable<int> value);
    partial void OnToItemIDChanged();
    ...
    partial void OnFromItemNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ToActName", DbType="NVarChar(500)")]
		public string ToActName
		{
			get
			{
				return this._ToActName;
			}
			set
			{
				if ((this._ToActName != value))
				{
					this.OnToActNameChanging(value);
					this.SendPropertyChanging();
					this._ToActName = value;
					this.SendPropertyChanged("ToActName");
					this.OnToActNameChanged();
				}
			}
		}
